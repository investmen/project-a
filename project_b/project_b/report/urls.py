...
from project_b.report.views import (
    property_evaluator_form_view,
    report_create_view,
    evaluator_report_list_view,
    property_form_view,
    property_report_list_view,
    report_request_create_view
)
...
urlpatterns = [
    ...
    path('evaluator/<int:evaluator_id>/report_list/', view=evaluator_report_list_view, name='evaluator_report_list'),
    ...
    path('property/evaluator_search/', view=property_evaluator_form_view, name='property_evaluator_search'),
    path('property/<int:property_id>/report_create/', view=report_create_view, name='property_report_create'),
    path('property/search/', view=property_form_view, name='property_search'),
    path('property/<int:property_id>/report_list/', view=property_report_list_view, name='property_report_list'),
    path('property/<int:property_id>/report_request/<int:report_id>/', view=report_request_create_view, name='property_report_request'),
